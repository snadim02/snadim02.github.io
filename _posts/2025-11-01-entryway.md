...
Getting around (wavy, uneven) corners is *still the absolute worst*. I wanted to abandon the effort after the first corner (of *three*!). :rage:

![Entryway before](../assets/img/entryway-abandoned.jpg){: .mx-auto.d-block :}

Luckily I also [can't stand a half-finished project](https://add.org/adhd-hyperfocus/), so I powered through the rest. :skull:
