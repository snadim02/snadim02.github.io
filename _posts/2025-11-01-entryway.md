...
subtitle: step through our clown car entryway
...
Our teensy entryway used to be a master illusion: impossibly small but concealing a mountain of stuff. :circus_tent: :upside_down_face: I finally fixed the vibe so that guests will feel like they're walking into our actual home 
instead of accidentally into a storage closet. :coat: :scarf: :handbag: :boot:

## Come one, come all! 

During Covid, we transformed our front entryway into a makeshift mudroom to avoid using our condo's shared back stairwell. :boot: :kick_scooter: :military_helmet: :umbrella: But 
once we [reworked our basement storage unit](../2024-02-01-storage-unit) to take on that functionality instead, this space became our main guest entrance (in need of an overhaul). [Scroll down](#problems--solutions) to see how we fixed it up! 

![Entryway before](../assets/img/entryway-before.jpg){: .mx-auto.d-block :}
*:point_up: The (old) view when you entered our unit from the front condo hallway.*

:sparkle: *Ta da!* :sparkle: More welcoming than before, I hope. The hallway art and mirror were relocated from our [old master bedroom](../2025-05-12-kid-bedroom) once we [moved upstairs](../2025-03-15-master-bedroom).

![Entryway after](../assets/img/entryway-after1.jpg){: .mx-auto.d-block :}

![Entryway after](../assets/img/entryway-cover.jpg){: .mx-auto.d-block :}

## Problems & Solutions

**Jump ahead to see** how we dealt with the [teensy space](#problem-1-teensy-space) with [bulky storage](#problem-2-funhouse-furniture), an [off-center wall sconce](#problem-3-off-center-lighting), [wavy wall edges](#problem-4-wavy-corners-for-wallpapering), and a [scary stairwell](#problem-5-stairwell-of-doom).
...
> **Random Sidenote:** in grad school, while TA-ing [COS 126](https://introcs.cs.princeton.edu/java/stdlib/javadoc/Picture.html), I wrote a [Java program](../assets/img/picture-ratio.txt) that finds the closest standard print size (e.g., 4x6") for any irregularly-sized image (e.g., 2.25x4.75") and adds padding so it prints at the right size and full resolution. I **still** use it to update the pictures in those multi-opening picture frames (though I could probably [vibe code](https://cloud.google.com/discover/what-is-vibe-coding) a better version today) !
...
*:point_right: To the right into the kitchen and dining. You can get a better view of our [family pictures in the hallway](../2025-12-16-gallery-wall/#family-pictures) in my [gallery wall art post](../2025-12-16-gallery-wall)!*
