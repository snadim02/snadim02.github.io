...
of the wallpaper I liked from [Giffy Walls](https://www.giffywalls.com/) for the exact dimensions of my wall. I found 
...
**Label holder drawer pulls.** One of my favorite parts of this space is these 
...
rails to match the backsplash and scrubbed the brackets with acetone nail polish remover
...
But that's a silly argument, since I forgot about all of these things, which is effectively the same as 
not having it anyway. :roll_eyes:! *My first step was clearing out all the mystery bits and bobs.*

They say it gets worse before it gets better, and yep...

![wall patching](../assets/img/laundry11.jpg){: .mx-auto.d-block :}

I laid everything out to edit and organize. SHere are some things that stayed, including an updated [minimum stash of home tools](https://www.reddit.com/r/Tools/comments/13klh7x/what_are_some_home_essentialsmusthave_tools/):
