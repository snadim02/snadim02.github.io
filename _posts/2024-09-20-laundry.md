...
* [Stacked washer/dryer](#step-3-custom-cabinetry-built-ins) :basket: :soap:
  ...
  * dryer vent ducting overlaps with cabinet
...
| Challenge | Solution | 
| --- | --- | 
| Door is unfinished. :evergreen_tree: | :heavy_check_mark: Pine was sanded, primed, sanded, and painted twice! :woman_artist: | 
| Unused bifold track shortened door slab by 1.5". :door: | :heavy_check_mark: Added strips of wood to the top of the door frame to fill the gap. | 
...
because of the flexibility for shelves and cabinet doors. The unit required some tweaks:
...
washer and dryer** instead of moving them out first (as they were instructed and agreed to do). :woman_facepalming:

:fire: **Problem 1: The dryer smells like a fire!** :fire: 
> The evening that my carpenter left, I tried to dry a wet floor towel (that our kiddo had dumped a bunch of bath water onto). Within a few minutes, 
a *horrible burning smell and a bunch of steam started to fill the room!* :scream: :fire_extinguisher: :woman_firefighter: :safety_vest:

I called in the [Dryer Vent Wizards](https://www.dryerventwizard.com/locations/greater-boston) (highly recommend!), and they found
and fixed a couple of problems... 

![layout](../assets/img/laundry23.jpg){: .mx-auto.d-block :}
***Fix:** Used a multitool to cut up the cabinet from the outside (then crafted and installed a box to cover the hole from the inside).*

![layout](../assets/img/laundry24.jpg){: .mx-auto.d-block :}
***Fix:** Reconnected and screwed in the dryer vent.*

Unfortunately, this led to another new problem the next day...

:ocean: **Problem 2: The washer is leaking!** :ocean: 
...
We live in a 3rd-floor condo, and I'm not interested in a leaking washer...

Getting a new drip pan in there was tricky! We couldn't plop the washer/dryer
on top (because of the built-in overhead cabinet), and couldn't slide the drip pan in *with the washer/dryer* because the overflow drain pipe was in the middle of the floor! 
...
4. Lift the front of washer/dryer with [manual jacks](https://www.amazon.com/gp/product/B0CH33RLV1/) and push drip pan front into place. 
