...
(Unoriginal) Brainstorm Attempt #1: generate AI renderings of our master bathroom for ideas. Disappointment. :anguished: Attempt #2: code a to-scale 3D rendering of our space using AI. Yay! :star_struck: My mind is blown with how I completed this design in a weekend before any expensive regrets. :toilet: :bath: :shower: :plunger:
...
|---|---|
| :x: Pocket door falls off track. | :door: We get stuck inside! |
| :x: Sink drainpipe is incorrectly installed. | Sink doesn't drain... | 
| :x: Shower threshold installed at an outward angle. | :shower: Water flows out all over the floor. | 
...
:point_up: I used Gemini to render this space with glass tiles that I liked and a hex floor with terracotta dots. I wanted two cabinet mirrors and a vanity with drawers for better storage. :mirror: :lotion_bottle: :toothbrush: :roll_of_paper:

And another before/after rendering from a different angle: 

![Closet](../assets/img/masterbath-before2.jpg){: .mx-auto.d-block :}

![Closet](../assets/img/masterbath-inspo3.jpg){: .mx-auto.d-block :}

Clearly, AI randomly switches up finishes, dimensions, and other details, resulting in absolute slop where it's hard to imagine whether and how everything will fit. 
