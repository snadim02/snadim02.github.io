...
* access panel for dryer outlet and plug
* 6x6" cutout to accommodate dryer vent ducting
* doors that wouldn't hit the 9x9x3" home security box in front. 

![layout](../assets/img/laundry17.jpg){: .mx-auto.d-block :}

![layout](../assets/img/laundry22.jpg){: .mx-auto.d-block :}

**Half cabinet access.** I wanted the option of leaving the doors fully open to walk in and out with a laundry basket. 
...
while also still allowing shelf height switch-ups later on.

![layout](../assets/img/laundry21.jpg){: .mx-auto.d-block :}

### Step 3: Custom Cabinetry Built-Ins

Since the start of the semester was imminent, I hired the *only carpenter who responded* (of the eight folks I tried) to build the custom cabinet above 
