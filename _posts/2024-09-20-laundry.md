...
| Interior light switch is now blocked. :bulb: | :heavy_check_mark: Relocated switch to hallway using a [wireless receiver kit](https://www.amazon.com/gp/product/B09YHBHP8T/). | 
...
| Challenge | Solution | 
| --- | --- | 
| Cabinet is 90" high in a 93" high room. :ladder: | :heavy_check_mark: Build a 3" base instead of standard 4.5" legs |
...
| Dryer vent ducting overlaps cabinet. | :heavy_check_mark: Cut cabinet to accommodate! :carpentry_saw: | 
...
***Fix:** They used my multitool to cut up the cabinet from the outside (then I crafted and installed a box to cover the hole from the inside).*
...
specialty recycling
([textile recycling](https://www.cambridgema.gov/Services/textilesrecycling), 
broken electronics, [donations](https://www.facebook.com/groups/571919200610635)) :recycle:, 
and extra air filters :mask:, tissues :sneezing_face: and toilet paper :roll_of_paper:. 
...
For real: folks who do home projects save money by reusing supplies! For this project, 
